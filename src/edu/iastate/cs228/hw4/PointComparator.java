...
public class PointComparator implements Comparator<Point> {
	...
	public int compare(Point p1, Point p2) {
		if (p1.equals(referencePoint) && !(p1.equals(p2))) {
			...
			return -1;
				...
				&& !(p2.equals(referencePoint) && compareDistance(p1, p2) == -1)
	...
	public int comparePolarAngle(Point p1, Point p2) {
		if (p1.equals(referencePoint)
				|| referencePoint.getX() * p1.getY() - p1.getX()
						* referencePoint.getY() < referencePoint.getX()
						* p2.getY() - p2.getX() * referencePoint.getY()) {
			return -1;
		} else if (referencePoint.getX() * p1.getY() - p1.getX()
				* referencePoint.getY() == referencePoint.getX() * p2.getY()
				- p2.getX() * referencePoint.getY()) {
			return 0;
		} else {
			return 1;
		}
	...
	public int compareDistance(Point p1, Point p2) {
		if (referencePoint.getX() * p1.getX() + referencePoint.getY()
				* p1.getY() < referencePoint.getX() * p2.getX()
				+ referencePoint.getY() * p2.getY()) {
			return -1;
		} else if (referencePoint.getX() * p1.getX() + referencePoint.getY()
				* p1.getY() == referencePoint.getX() * p2.getX()
				+ referencePoint.getY() * p2.getY()) {
			return 0;
		} else {
